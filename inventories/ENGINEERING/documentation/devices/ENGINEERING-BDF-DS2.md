...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.41/24 | 172.16.1.1 |
...
| ------- | -------- | ---------- | ----- |
| Network Engineering // 281.330.8004 | ENGINEERING_FABRIC ENGINEERING ENGINEERING-BDF-DS2 | All | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 62cd4d0a5902f304443b880741820e099872d728 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| demoV3 | DEMO_RO | v3 | sha | aes | - | - | 62cd4d0a5902f304443b880741820e099872d728 |
| demoRW | DEMO_RW | v3 | sha | aes | - | - | 62cd4d0a5902f304443b880741820e099872d728 |
...
snmp-server engineID local 62cd4d0a5902f304443b880741820e099872d728
snmp-server contact Network Engineering // 281.330.8004
snmp-server location ENGINEERING_FABRIC ENGINEERING ENGINEERING-BDF-DS2
...
snmp-server user demoRW DEMO_RW v3 localized 62cd4d0a5902f304443b880741820e099872d728 auth sha <removed> priv aes <removed>
snmp-server user demoV3 DEMO_RO v3 localized 62cd4d0a5902f304443b880741820e099872d728 auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| ENGINEERING_L3_LEAF1 | Vlan4094 | 10.252.8.0 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_ENGINEERING-TX1-ES1_Ethernet50 | *trunk | *22,122,222,250,333,4092 | *- | *- | 1 |
| Ethernet2 | L2_ENGINEERING-TX1-ES2_Ethernet50 | *trunk | *22,122,222,250,333,4092 | *- | *- | 2 |
| Ethernet55/1 | MLAG_ENGINEERING-BDF-DS1_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_ENGINEERING-BDF-DS1_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet48 | P2P_BACKBONE-M12-AR1_Ethernet1 | - | 10.252.4.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description L2_ENGINEERING-TX1-ES1_Ethernet50
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_ENGINEERING-TX1-ES2_Ethernet50
   no shutdown
   channel-group 2 mode active
!
interface Ethernet48
   description P2P_BACKBONE-M12-AR1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.252.4.3/31
   pim ipv4 sparse-mode
!
interface Ethernet55/1
   description MLAG_ENGINEERING-BDF-DS1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_ENGINEERING-BDF-DS1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_ENGINEERING-BDF-DS1_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel551
   description MLAG_ENGINEERING-BDF-DS1_Port-Channel551
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.252.8.68/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.252.8.131/32 |
| Loopback2 | SFLOW SOURCE | default | 10.255.1.10/32 |
| Loopback10 | DIAG_VRF_campus | campus | 10.252.65.36/32 |
| Loopback11 | DIAG_VRF_IOT | IOT | 10.253.65.36/32 |
...
interface Loopback10
   ...
   no shutdown
   vrf campus
   ip address 10.252.65.36/32
!
interface Loopback11
   description DIAG_VRF_IOT
   no shutdown
   vrf IOT
   ip address 10.253.65.36/32
```
...
| Vlan3009 |  campus  |  10.252.8.3/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  IOT  |  10.252.8.3/31  |  -  |  -  |  -  |  -  |
| Vlan4092 |  default  |  10.252.8.195/26  |  -  |  10.252.8.193  |  -  |  -  |
| Vlan4093 |  default  |  10.252.8.3/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.252.8.1/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description ENGINEERING-BDF-DS2_VTEP
...
| 10.252.4.2 | 65000.21 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.8.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.252.8.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | campus | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.252.8.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | IOT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 22 | 10.252.8.68:10022 | 10022:10022 | - | - | learned |
| 122 | 10.252.8.68:10122 | 10122:10122 | - | - | learned |
| 222 | 10.252.8.68:10222 | 10222:10222 | - | - | learned |
| 250 | 10.252.8.68:10250 | 10250:10250 | - | - | learned |
| 333 | 10.252.8.68:10333 | 10333:10333 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| campus | 10.252.8.68:10 | connected | IPv4: True<br>Transit: False |
| IOT | 10.252.8.68:11 | connected | IPv4: True<br>Transit: False |
...
router bgp 65000.998
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENGINEERING-BDF-DS1
   ...
   neighbor 10.252.4.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.4.2 remote-as 65000.21
   neighbor 10.252.4.2 local-as 65000.402 no-prepend replace-as
   neighbor 10.252.4.2 description BACKBONE-M12-AR1
   neighbor 10.252.8.2 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.252.8.2 description ENGINEERING-BDF-DS1_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   redistribute attached-host
   !
   vlan 22
      rd 10.252.8.68:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 122
      rd 10.252.8.68:10122
      route-target both 10122:10122
      redistribute learned
   !
   vlan 222
      rd 10.252.8.68:10222
      route-target both 10222:10222
      redistribute learned
   !
   vlan 250
      rd 10.252.8.68:10250
      route-target both 10250:10250
      redistribute learned
   !
   vlan 333
      rd 10.252.8.68:10333
   ...
   vrf campus
      ...
      router-id 10.252.8.68
      neighbor 10.252.8.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.8.2 description ENGINEERING-BDF-DS1_Vlan3009
   ...
   vrf IOT
      ...
      router-id 10.252.8.68
      neighbor 10.252.8.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.8.2 description ENGINEERING-BDF-DS1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      evpn multicast
```
...
```eos
!
ip address virtual source-nat vrf campus address 10.252.65.36
ip address virtual source-nat vrf IOT address 10.253.65.36
```
