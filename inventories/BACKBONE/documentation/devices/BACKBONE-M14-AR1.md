...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.24/24 | 172.16.1.1 |
...
| ------- | -------- | ---------- | ----- |
| Network Engineering // 281.330.8004 | BACKBONE_FABRIC BACKBONE BACKBONE-M14-AR1 | All | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 3d0fda0cef95586e54f292db9a21a847dc211280 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| demoV3 | DEMO_RO | v3 | sha | aes | - | - | 3d0fda0cef95586e54f292db9a21a847dc211280 |
| demoRW | DEMO_RW | v3 | sha | aes | - | - | 3d0fda0cef95586e54f292db9a21a847dc211280 |
...
snmp-server engineID local 3d0fda0cef95586e54f292db9a21a847dc211280
snmp-server contact Network Engineering // 281.330.8004
snmp-server location BACKBONE_FABRIC BACKBONE BACKBONE-M14-AR1
...
snmp-server user demoRW DEMO_RW v3 localized 3d0fda0cef95586e54f292db9a21a847dc211280 auth sha <removed> priv aes <removed>
snmp-server user demoV3 DEMO_RO v3 localized 3d0fda0cef95586e54f292db9a21a847dc211280 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.252.0.12/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.252.0.76 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.0.78 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65000.12
   ...
   neighbor 10.252.0.76 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.0.76 remote-as 65000.1
   neighbor 10.252.0.76 description BACKBONE-M11-CR1_Ethernet30/1
   neighbor 10.252.0.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.0.78 remote-as 65000.1
   neighbor 10.252.0.78 description BACKBONE-M12-CR1_Ethernet30/1
