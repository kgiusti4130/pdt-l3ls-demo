...
| ------- | -------- | ---------- | ----- |
| Network Engineering // 281.330.8004 | BACKBONE_FABRIC BACKBONE BACKBONE-M11-AR1 | All | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| demoV3 | DEMO_RO | v3 | sha | aes | - | - | 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99 |
| demoRW | DEMO_RW | v3 | sha | aes | - | - | 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99 |
...
snmp-server engineID local 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99
snmp-server contact Network Engineering // 281.330.8004
snmp-server location BACKBONE_FABRIC BACKBONE BACKBONE-M11-AR1
...
snmp-server user demoRW DEMO_RW v3 localized 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99 auth sha <removed> priv aes <removed>
snmp-server user demoV3 DEMO_RO v3 localized 70e320dc0f90d44d7e2d5ce354ca1ba48493cf99 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_ENGINEERING-BDF-DS1_Ethernet48 | - | 10.252.4.0/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_FINANCE-BDF-DS1_Ethernet48 | - | 10.252.4.4/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_MARKETING-BDF-DS1_Ethernet48 | - | 10.252.4.8/31 | default | 9214 | False | - | - |
| Ethernet49/1 | P2P_BACKBONE-M11-CR1_Ethernet27/1 | - | 10.252.0.65/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_BACKBONE-M12-CR1_Ethernet27/1 | - | 10.252.0.67/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_ENGINEERING-BDF-DS1_Ethernet48
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.4.0/31
   pim ipv4 sparse-mode
!
interface Ethernet2
   description P2P_FINANCE-BDF-DS1_Ethernet48
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.4.4/31
   pim ipv4 sparse-mode
!
interface Ethernet3
   description P2P_MARKETING-BDF-DS1_Ethernet48
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.4.8/31
   pim ipv4 sparse-mode
!
interface Ethernet49/1
   description P2P_BACKBONE-M11-CR1_Ethernet27/1
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.0.65/31
   pim ipv4 sparse-mode
!
interface Ethernet50/1
   description P2P_BACKBONE-M12-CR1_Ethernet27/1
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.0.67/31
   pim ipv4 sparse-mode
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.252.0.9/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.252.0.64 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.0.66 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.4.1 | 65000.402 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.4.5 | 65000.303 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.4.9 | 65000.302 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65000.11
   ...
   neighbor 10.252.0.64 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.0.64 remote-as 65000.1
   neighbor 10.252.0.64 description BACKBONE-M11-CR1_Ethernet27/1
   neighbor 10.252.0.66 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.0.66 remote-as 65000.1
   neighbor 10.252.0.66 description BACKBONE-M12-CR1_Ethernet27/1
   neighbor 10.252.4.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.4.1 remote-as 65000.402
   neighbor 10.252.4.1 description ENGINEERING-BDF-DS1
   neighbor 10.252.4.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.4.5 remote-as 65000.303
   neighbor 10.252.4.5 description FINANCE-BDF-DS1
   neighbor 10.252.4.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.4.9 remote-as 65000.302
   neighbor 10.252.4.9 description MARKETING-BDF-DS1
