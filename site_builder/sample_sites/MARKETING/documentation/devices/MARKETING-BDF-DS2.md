...
| ------- | -------- | ---------- | ----- |
| Network Engineering // 281.330.8004 | MARKETING_FABRIC MARKETING MARKETING-BDF-DS2 | All | Disabled |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| demoV3 | DEMO_RO | v3 | sha | aes | - | - | c4789047baf85a2518c5e2672444f4cc3c223757 |
| demoRW | DEMO_RW | v3 | sha | aes | - | - | c4789047baf85a2518c5e2672444f4cc3c223757 |
...
snmp-server user demoRW DEMO_RW v3 localized c4789047baf85a2518c5e2672444f4cc3c223757 auth sha <removed> priv aes <removed>
snmp-server user demoV3 DEMO_RO v3 localized c4789047baf85a2518c5e2672444f4cc3c223757 auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| MARKETING_L3_LEAF1 | Vlan4094 | 10.252.1.0 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_MARKETING-TX1-ES1_Ethernet50 | *trunk | *42,142,242,250,4092 | *- | *- | 1 |
| Ethernet2 | L2_MARKETING-TX1-ES2_Ethernet50 | *trunk | *42,142,242,250,4092 | *- | *- | 2 |
| Ethernet55/1 | MLAG_MARKETING-BDF-DS1_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_MARKETING-BDF-DS1_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet48 | P2P_BACKBONE-M13-AR1_Ethernet3 | - | 10.252.4.11/31 | default | 9214 | False | - | - |
...
| Port-Channel551 | MLAG_MARKETING-BDF-DS1_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
| Vlan3009 |  campus  |  10.252.1.3/31  |  -  |  -  |  -  |  -  |
| Vlan4092 |  default  |  10.252.1.195/26  |  -  |  10.252.1.193  |  -  |  -  |
| Vlan4093 |  default  |  10.252.1.3/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.252.1.1/31  |  -  |  -  |  -  |  -  |
...
| 10.252.1.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.252.4.10 | 65000.22 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.1.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | campus | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 42 | 10.252.1.68:10042 | 10042:10042 | - | - | learned |
| 142 | 10.252.1.68:10142 | 10142:10142 | - | - | learned |
| 242 | 10.252.1.68:10242 | 10242:10242 | - | - | learned |
| 250 | 10.252.1.68:10250 | 10250:10250 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| campus | 10.252.1.68:10 | connected | IPv4: True<br>Transit: False |
