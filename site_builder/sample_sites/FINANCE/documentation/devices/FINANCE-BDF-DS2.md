...
| ------- | -------- | ---------- | ----- |
| Network Engineering // 281.330.8004 | FINANCE_FABRIC FINANCE FINANCE-BDF-DS2 | All | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | ee614b381ccdec35dee6791a64e82c0ea31c5023 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| demoV3 | DEMO_RO | v3 | sha | aes | - | - | ee614b381ccdec35dee6791a64e82c0ea31c5023 |
| demoRW | DEMO_RW | v3 | sha | aes | - | - | ee614b381ccdec35dee6791a64e82c0ea31c5023 |
...
snmp-server engineID local ee614b381ccdec35dee6791a64e82c0ea31c5023
snmp-server contact Network Engineering // 281.330.8004
snmp-server location FINANCE_FABRIC FINANCE FINANCE-BDF-DS2
...
snmp-server user demoRW DEMO_RW v3 localized ee614b381ccdec35dee6791a64e82c0ea31c5023 auth sha <removed> priv aes <removed>
snmp-server user demoV3 DEMO_RO v3 localized ee614b381ccdec35dee6791a64e82c0ea31c5023 auth sha <removed> priv aes <removed>
...
| --------- | --------------- | ------------ | --------- |
| FINANCE_L3_LEAF1 | Vlan4094 | 10.252.9.0 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_FINANCE-TX1-ES1_Ethernet50 | *trunk | *32,132,232,250,4092 | *- | *- | 1 |
| Ethernet2 | L2_FINANCE-TX1-ES2_Ethernet50 | *trunk | *32,132,232,250,4092 | *- | *- | 2 |
| Ethernet55/1 | MLAG_FINANCE-BDF-DS1_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_FINANCE-BDF-DS1_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet48 | P2P_BACKBONE-M13-AR1_Ethernet2 | - | 10.252.4.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description L2_FINANCE-TX1-ES1_Ethernet50
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_FINANCE-TX1-ES2_Ethernet50
   no shutdown
   channel-group 2 mode active
!
interface Ethernet48
   description P2P_BACKBONE-M13-AR1_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.252.4.7/31
   pim ipv4 sparse-mode
!
interface Ethernet55/1
   description MLAG_FINANCE-BDF-DS1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_FINANCE-BDF-DS1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_FINANCE-BDF-DS1_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel551
   description MLAG_FINANCE-BDF-DS1_Port-Channel551
   no shutdown
   switchport mode trunk
...
| Vlan3009 |  campus  |  10.252.9.3/31  |  -  |  -  |  -  |  -  |
| Vlan4092 |  default  |  10.252.9.195/26  |  -  |  10.252.9.193  |  -  |  -  |
| Vlan4093 |  default  |  10.252.9.3/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.252.9.1/31  |  -  |  -  |  -  |  -  |
...
interface Vlan3009
   ...
   mtu 9214
   vrf campus
   ip address 10.252.9.3/31
!
interface Vlan4092
   description Inband Management
   no shutdown
   mtu 1500
   ip address 10.252.9.195/26
...
!
interface Vxlan1
   description FINANCE-BDF-DS2_VTEP
...
| 10.252.4.6 | 65000.22 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.252.9.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.252.9.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | campus | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 32 | 10.252.9.68:10032 | 10032:10032 | - | - | learned |
| 132 | 10.252.9.68:10132 | 10132:10132 | - | - | learned |
| 232 | 10.252.9.68:10232 | 10232:10232 | - | - | learned |
| 250 | 10.252.9.68:10250 | 10250:10250 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| campus | 10.252.9.68:10 | connected | IPv4: True<br>Transit: False |
...
router bgp 65000.999
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description FINANCE-BDF-DS1
   ...
   neighbor 10.252.4.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.252.4.6 remote-as 65000.22
   neighbor 10.252.4.6 local-as 65000.303 no-prepend replace-as
   neighbor 10.252.4.6 description BACKBONE-M13-AR1
   neighbor 10.252.9.2 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.252.9.2 description FINANCE-BDF-DS1_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   redistribute attached-host
   !
   vlan 32
      rd 10.252.9.68:10032
      route-target both 10032:10032
      redistribute learned
   !
   vlan 132
      rd 10.252.9.68:10132
      route-target both 10132:10132
      redistribute learned
   !
   vlan 232
      rd 10.252.9.68:10232
      route-target both 10232:10232
      redistribute learned
   !
   vlan 250
      rd 10.252.9.68:10250
   ...
   vrf campus
      ...
      update wait-install
      neighbor 10.252.9.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.9.2 description FINANCE-BDF-DS1_Vlan3009
...
```eos
!
ip address virtual source-nat vrf campus address 10.252.97.36
```
